...
The module generates coverage and seed files, runs clustering, writes FASTA bins to `output_bins`,and creates `contig_bins.tsv` using DAS Tool.
...
### 16. Assess bin quality with CheckM2
